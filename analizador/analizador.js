...
function peg$parse(input, options) {
  ...
  var peg$e39 = peg$classExpectation(["\"", "\\", "n", "r", "t", "\""], false, false);
  ...
  var peg$e43 = peg$literalExpectation("boolean", false);
  var peg$e44 = peg$literalExpectation("char", false);
  var peg$e45 = peg$literalExpectation("var", false);
  ...
  var peg$f19 = function(id, op, der) { return { tipo: op, der } };
  var peg$f20 = function(id, expansion) {
  ...
  var peg$f23 = function(izq, der) { return der };
  ...
  var peg$f25 = function(cond, expTrue, expFalse) { return crearNodo('ternario', { cond, expTrue, expFalse }) };
  ...
  var peg$f35 = function(num) { return crearNodo('unaria', { op: '!', exp: num }) };
  var peg$f36 = function(callee, args) {return args};
  var peg$f37 = function(callee, params) {
  ...
  var peg$f42 = function(id) { return crearNodo('referenciaVariable', { id }) };
  ...
  var peg$f45 = function(chars) {return crearNodo('cadena', {tipo: 'string', valor: chars.join('')})};
  var peg$f46 = function(chars) {return crearNodo('cadena', {tipo: 'char', valor: chars})};
  var peg$f47 = function(esc) { 
    switch (esc) {
        case 'n': return '\n';
        case 't': return '\t';
        case 'r': return '\r';
  ...
  var peg$f49 = function() { const id = text(); return id;};
  var peg$f50 = function() { return crearNodo('booleano', {tipo: 'boolean', valor: true})};
  var peg$f51 = function() { return crearNodo('booleano', {tipo: 'boolean', valor: false})};
