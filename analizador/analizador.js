...
function peg$parse(input, options) {
  ...
  var peg$e23 = peg$literalExpectation("indexOf", false);
  var peg$e24 = peg$literalExpectation("join", false);
  ...
  var peg$f29 = function(id, method, exp) {return exp};
  var peg$f30 = function(id, method, exp) {return crearNodo('arrayFunc', { id, method, exp })};
  var peg$f31 = function(id, index, value) {return crearNodo('arrayFunc', { id, method:'setElement', exp:[index, value]});};
  var peg$f32 = function(id, index) {const value = null; return crearNodo('arrayFunc', { id, method:'getElement', exp:[index,value]});};
  var peg$f33 = function(id, op, der) { return { tipo: op, der } };
  var peg$f34 = function(id, expansion) {
  ...
  var peg$f36 = function(izq, der) { return der };
  ...
  var peg$f38 = function(izq, der) { return der };
  ...
  var peg$f54 = function(exp) { return crearNodo('agrupacion', { exp }) };
